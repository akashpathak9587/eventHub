...
const EventDetails = async ({ params: { id }, searchParams }: SearchParamProps) => {
  ...
  return (
        ...
        <div className="flex w-full flex-col gap-8 p-5 md:p-10">
          ...
          <div className="flex flex-col gap-5">
            <div className="flex gap-2 md:gap-3">
              ...
              <div className="p-medium-16 lg:p-regular-20 flex flex-wrap items-center gap-5">
                <p>
    ...
    <section className="wrapper my-8 flex flex-col gap-8 md:gap-12">
        ...
        <Collection data={relatedEvents?.data} emptyTitle="No Events Found" emptyStateSubtext="Come back later" collectionType="All_Events" page={searchParams.page as string} totalPages={relatedEvents?.totalPages} limit={3}/>
    </section>
    </>
  );
};
