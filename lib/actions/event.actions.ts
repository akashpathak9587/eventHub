...
import { CreateEventParams, GetRelatedEventsByCategoryParams, UpdateEventParams } from "@/types";
...
export async function updateEvent({userId, event, path}:UpdateEventParams) {
  try {
    ...
    if (!eventToUpdate || eventToUpdate.organizer.toHexString() !== userId) throw new Error("Unauthorized or event not found");
